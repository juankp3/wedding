function confirmModal(e,o){e=`
    ...
    `;$("body").append(e);const n=$("#confirm__modal");var e=n.find(".close"),t=n.find("#okBtn");n.css("display","flex"),e.click(function(){n.remove()}),t.click(function(){n.remove(),"function"==typeof o&&o()})}function createOKModal(e,o){e=`
    ...
    `;$("body").append(e);const n=$("#confirm__action");var e=n.find(".close"),t=n.find("#btnOK");n.css("display","flex"),e.click(function(){n.remove()}),t.click(function(){n.remove(),"function"==typeof o&&o()})}function createYesNoModal(e,o){e=`
        <div id="confirm__action" class="modal modal__small">
          <div class="modal__container">
            <div class="modal__header">
              <h2>Confirmación</h2>
