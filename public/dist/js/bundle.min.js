function confirmModal(e,o){e=`
    ...
    `;$("body").append(e);const n=$("#confirm__modal");var e=n.find(".close"),a=n.find("#okBtn");n.css("display","flex"),e.click(function(){n.remove()}),a.click(function(){n.remove(),"function"==typeof o&&o()})}function createYesNoModal(e,o){e=`
