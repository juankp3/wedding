        ...
        <div class="header pb-5">
          <div class="container-fluid">
            ...
            <div class="header-footer">
              ...
              <!-- Chart -->
              <div class="chart">
                <canvas id="audienceChart" class="chart-canvas" width="1598" height="300" style="display: block; box-sizing: border-box; height: 300px; width: 1598px;"></canvas>
              <div id="chart-tooltip" role="tooltip" class="popover bs-popover-top" style="visibility: hidden; left: 318.523px; top: 216.075px; transform: translateX(-50%) translateY(-100%) translateY(-1rem);"><div class="popover-arrow translate-middle-x"></div><div class="popover-content"><div><h3 class="popover-header text-center text-nowrap">Mar</h3></div><div><div class="popover-body d-flex align-items-center text-nowrap justify-content-center"><span class="popover-body-indicator" style="background-color: rgb(44, 123, 229);"></span> 5k</div></div></div></div></div>
          ...
          <div class="col-12 col-xl-8">
            ...
            <div class="card">
              ...
              <div class="card-body">
                ...
                <!-- Chart -->
                <div class="chart">
                  <canvas id="ordersChart" class="chart-canvas" width="1007" height="300" style="display: block; box-sizing: border-box; height: 300px; width: 1007px;"></canvas>
                <div id="chart-tooltip" role="tooltip" class="popover bs-popover-top" style="visibility: hidden; left: 89.7767px; top: 102.775px; transform: translateX(-50%) translateY(-100%) translateY(-1rem);"><div class="popover-arrow translate-middle-x"></div><div class="popover-content"><div><h3 class="popover-header text-center text-nowrap">Jan</h3></div><div><div class="popover-body d-flex align-items-center text-nowrap justify-content-center"><span class="popover-body-indicator" style="background-color: rgb(44, 123, 229);"></span> $25k</div></div></div></div></div>
            ...
            <div class="card">
              <div class="card-header">
                ...
                <ul class="nav nav-tabs nav-tabs-sm card-header-tabs" role="tablist">
                  <li class="nav-item" data-toggle="chart" data-target="#trafficChart" data-trigger="click" data-action="toggle" data-dataset="0" role="presentation">
                    <a href="#" class="nav-link active" data-bs-toggle="tab" aria-selected="true" role="tab">
                      All
                    </a>
                  </li>
                  <li class="nav-item" data-toggle="chart" data-target="#trafficChart" data-trigger="click" data-action="toggle" data-dataset="1" role="presentation">
                    <a href="#" class="nav-link" data-bs-toggle="tab" aria-selected="false" tabindex="-1" role="tab">
                      Direct
                    </a>
                  </li>
                </ul>
              ...
              <div class="card-body">
                ...
                <div class="chart chart-appended">
                  <canvas id="trafficChart" class="chart-canvas" data-toggle="legend" data-target="#trafficChartLegend" width="466" height="240" style="display: block; box-sizing: border-box; height: 240px; width: 466px;"></canvas>
                </div>
              ...
              <div class="table-responsive mb-0" data-list="{&quot;valueNames&quot;: [&quot;products-product&quot;, &quot;products-stock&quot;, &quot;products-price&quot;, &quot;products-sales&quot;]}" id="productsList">
                <table class="table table-sm table-nowrap table-hover card-table">
                  <thead>
                    <tr>
                      <th>
                        <a href="#" class="text-body-secondary list-sort" data-sort="products-product">
                          Product
                        </a>
                      </th>
                      <th>
                        <a href="#" class="text-body-secondary list-sort" data-sort="products-stock">
                          Stock
                        </a>
                      </th>
                      <th>
                        <a href="#" class="text-body-secondary list-sort" data-sort="products-price">
                          Price
                        </a>
                      </th>
                      <th colspan="2">
                        <a href="#" class="text-body-secondary list-sort" data-sort="products-sales">
                          Monthly Sales
                        </a>
                      </th>
                    </tr>
                  ...
                  <tbody class="list"><tr>
                      <td class="products-product">
                        <div class="d-flex align-items-center">
                          ...
                          <!-- Image -->
                          <div class="avatar">
                            <img class="avatar-img rounded me-3" src="assets/img/avatars/products/product-1.jpg" alt="...">
                          </div>
                          ...
                          <div class="ms-3">
                            ...
                            <!-- Text -->
                            <small class="text-body-secondary">3" x 5" Size</small>
                      ...
                      <td class="products-stock">
                        ...
                        <!-- Badge -->
                        <span class="badge text-bg-success-subtle">Available</span>
                      ...
                      <td class="products-product">
                        <div class="d-flex align-items-center">
                          ...
                          <!-- Image -->
                          <div class="avatar">
                            <img class="avatar-img rounded me-3" src="assets/img/avatars/products/product-2.jpg" alt="...">
                          </div>
                          ...
                          <div class="ms-3">
                            ...
                            <!-- Text -->
                            <small class="text-body-secondary">UV + Blue Light</small>
                      ...
                      <td class="products-stock">
                        ...
                        <!-- Badge -->
                        <span class="badge text-bg-warning-subtle">Unavailable</span>
                      ...
                      <td class="products-product">
                        <div class="d-flex align-items-center">
                          ...
                          <!-- Image -->
                          <div class="avatar">
                            <img class="avatar-img rounded me-3" src="assets/img/avatars/products/product-3.jpg" alt="...">
                          </div>
                          ...
                          <div class="ms-3">
                            ...
                            <!-- Text -->
                            <small class="text-body-secondary">Leather + Gortex</small>
                      ...
                      <td class="products-product">
                        <div class="d-flex align-items-center">
                          ...
                          <!-- Image -->
                          <div class="avatar">
                            <img class="avatar-img rounded me-3" src="assets/img/avatars/products/product-4.jpg" alt="...">
                          </div>
                          ...
                          <div class="ms-3">
                            ...
                            <!-- Text -->
                            <small class="text-body-secondary">Bone Clay White</small>
